// Provinsi + kabupaten/kota Indonesia (38 provinsi, 514 kab/kota).
// DIBANGKITKAN OTOMATIS dari repo POS (lib/wilayah.ts) - JANGAN sunting tangan.
// Sumber: Kepmendagri No 300.2.2-2430 Tahun 2025 (cahyadsn/wilayah, MIT)
// + kode pos per desa/kelurahan (cahyadsn/wilayah_kodepos, MIT).
//
// Penamaan SENGAJA sama persis dengan POS ("Kab. X", bukan "Kabupaten X")
// supaya data dari formulir ini bisa langsung dipakai admin tanpa diterjemahkan.
window.CC_WILAYAH = [
  {
    name: "Aceh",
    cities: [
      ...
      "Kab. Simeulue", "Kota Banda Aceh", "Kota Langsa", "Kota Lhokseumawe", "Kota Sabang",
      "Kota Subulussalam",
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Sanggau", "Kab. Sekadau", "Kab. Sintang", "Kota Pontianak", "Kota Singkawang",
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Tulang Bawang Barat", "Kab. Way Kanan", "Kota Bandar Lampung", "Kota Metro",
    ],
  },
  {
    name: "Maluku",
  ...
  },
  {
    name: "Papua Barat",
    cities: [
      "Kab. Fak Fak", "Kab. Kaimana", "Kab. Manokwari", "Kab. Manokwari Selatan",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Tana Toraja", "Kab. Toraja Utara", "Kab. Wajo", "Kota Makassar", "Kota Palopo",
      "Kota Parepare",
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Kep. Siau Tagulandang Biaro", "Kab. Kepulauan Sangihe", "Kab. Kepulauan Talaud",
      "Kab. Minahasa", "Kab. Minahasa Selatan", "Kab. Minahasa Tenggara",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Ogan Komering Ulu Timur", "Kab. Penukal Abab Lematang Ilir", "Kota Lubuk Linggau",
  ...
  },
  {
    ...
    cities: [
      ...
      "Kab. Tapanuli Utara", "Kab. Toba", "Kota Binjai", "Kota Gunungsitoli", "Kota Medan",
